...
export interface ChannelControl<X, Y> {
    ...
    setupAndValidateListener1(channel: X | null, listenContextType: string | null, expectedContextType: string | null, errorMessage: string, onComplete: (ctx: Y) => void, testId: string): void | Promise<void>;
    setupAndValidateListener2(channel: X | null, listenContextType: string | null, expectedContextType: string | null, errorMessage: string, onComplete: (ctx: Y) => void, testId: string): void | Promise<void>;
