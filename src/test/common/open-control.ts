export interface OpenControl<X>{
    ...
    expectAppTimeoutErrorOnOpen(context: X, appId?: string, appName?: string): Promise<void>
    ...
    validateReceivedContext(contextReceiver: Promise<X>, expectedContextType: string): Promise<void>
}
