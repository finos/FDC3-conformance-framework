...
export let fdc3BasicRI1_2_0  = () => describe("fdc3.basicRI1_2.0", () => basicRI1(fdc3, documentation_RI, Intent.aTestingIntent, ContextType.testContextX));
export let fdc3BasicRI2_2_0  = () => describe("fdc3.basicRI2_2.0", () => basicRI2(fdc3, documentation_RI, ContextType.testContextZ));