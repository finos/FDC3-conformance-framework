...
export default () =>
  ...
  describe("fdc3.raiseIntent (Result)", () => {
    ...
    it(RaiseIntentVoidResult5secs, async () => {
      errorListener = await control.listenForError();
      const receiver = control.receiveContext("aTestingIntent-listener-triggered", 8000);
    ...
    it(RaiseIntentContextResult5secs, async () => {
      errorListener = await control.listenForError();
      const receiver = control.receiveContext("sharedTestingIntent1-listener-triggered", 8000);
    ...
    it(RaiseIntentVoidResult61secs, async () => {
      errorListener = await control.listenForError();
      const receiver = control.receiveContext("aTestingIntent-listener-triggered", 64000);
    ...
    it(RaiseIntentContextResult61secs, async () => {
      errorListener = await control.listenForError();
      const receiver = control.receiveContext("sharedTestingIntent1-listener-triggered", 64000);
