  ...
  describe("fdc3.basicAC1", () => {
    it("(BasicAC1) Returns Channel object", async () => {
      try {
        ...
        expect(channel, getOrCreateChannelDocs).to.have.property("getCurrentContext");
        expect(channel, getOrCreateChannelDocs).to.have.property("addContextListener");
      } catch (ex) {
