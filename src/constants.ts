 ...
 */
 const constants = {
  ...
  TestTimeout: 900000, // Tests that take longer than this (in milliseconds) will fail
  WaitTime: 300000, // The amount of time to wait for mock apps to finish processing
